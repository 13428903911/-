<template>
	<view class="uni-load-more" @click="onClick">
		...
		<!-- #endif -->
		<text class="uni-load-more__text" :style="{color: color}"><text>{{ status === 'more' ? contentText.contentdown : status === 'loading' ? contentText.contentrefresh : contentText.contentnomore }}</text></text>
	</view>
</template>
